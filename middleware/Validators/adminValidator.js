...
const adminValidator = {
    ...
    masterTableValidate: [
        check('status_type')
        .trim()
        .notEmpty().withMessage('Status type is required.')
        .isString()
        ...
        .isString()
        .isLength({min: 2, max: 50}).withMessage('Plese enter valid status name.'),
    ],

    adminReqValid: (req, res, next) => {
