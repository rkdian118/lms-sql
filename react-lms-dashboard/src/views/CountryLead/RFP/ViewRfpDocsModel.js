...
import { ClusterGetRfpActivityDetailsApi } from 'store/slices/countryLeadAction';
...
const ViewRfpDocsModel = (props) => {
    ...
    const { getRfpList, getRfpLoading, getRfpActivityLoading, getRfpActivityData } = useSelector((state) => state.countryLeadAction);
