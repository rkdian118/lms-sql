...
import { GetCallActivityDetailsApi, AddCommentCallActivityApi } from 'store/slices/countryLeadAction';
...
const CallsActivityStatus = (props) => {
    ...
    const { open, close, AddCommentCallActivityApi, rowData, callById } = props;
    ...
    const handleUpdateActivityStatus = () => {
        ...
        dispatch(GetCallActivityDetailsApi(callById));
    };
    const initialValues = {
        new_Comment: ''
    };
    ...
    const onSubmit = (values, { setSubmitting }) => {
        ...
        AddCommentCallActivityApi(newData)
            .then((res) => {
...
export default connect(null, { AddCommentCallActivityApi })(CallsActivityStatus);
