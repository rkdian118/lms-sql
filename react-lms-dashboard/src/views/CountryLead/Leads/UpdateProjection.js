...
import { UpdateProjectionStatusApi } from 'store/slices/countryLeadAction';
...
const UpdateProjection = (props) => {
    ...
    const { open, close, UpdateProjectionStatusApi, projectStatusId, leadId } = props;
    ...
    const onSubmit = (values, { setSubmitting }) => {
        ...
        UpdateProjectionStatusApi(newData)
            .then((res) => {
...
export default connect(null, { UpdateProjectionStatusApi })(UpdateProjection);
