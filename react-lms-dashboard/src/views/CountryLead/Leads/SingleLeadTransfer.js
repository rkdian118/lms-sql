...
import { GetAllLeadDropDownApi, TransferLeadApi } from 'store/slices/countryLeadAction';
...
const SingleLeadTransfer = ({ open, close, TransferLeadApi, rowData }) => {
    ...
    const { getSelectedBdLeadDropdown, getBdeDropdownList, getLeadDropdown } = useSelector((state) => state.countryLeadAction);
