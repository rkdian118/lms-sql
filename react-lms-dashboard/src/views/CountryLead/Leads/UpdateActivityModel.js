...
import { UpdateBranchLeadActivityApi } from 'store/slices/countryLeadAction';
...
const UpdateActivityModel = (props) => {
    const theme = useTheme();
    const { open, close, UpdateBranchLeadActivityApi, activityId, leadId } = props;
    ...
    const onSubmit = (values, { setSubmitting }) => {
        ...
        UpdateBranchLeadActivityApi(newData)
            .then((res) => {
...
export default connect(null, { UpdateBranchLeadActivityApi })(UpdateActivityModel);
