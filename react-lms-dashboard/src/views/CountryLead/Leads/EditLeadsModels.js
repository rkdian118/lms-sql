...
import { BranchUpdateLeadApi } from 'store/slices/countryLeadAction';
...
const EditLeadsModels = (props) => {
    ...
    const { open, close, BranchUpdateLeadApi, rowData } = props;
...
export default connect(null, { BranchUpdateLeadApi })(EditLeadsModels);
