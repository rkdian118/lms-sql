...
import { GetLeadActivityDetailsApi, AddBranchCommentLeadActivityApi } from 'store/slices/countryLeadAction';
// tabs-
...
const LeadActivityStatus = (props) => {
    ...
    const { getLeadActivityData, getLeadActivityLoading } = useSelector((state) => state.countryLeadAction);
