...
import { ClusterGetRfpActivityDetailsApi } from 'store/slices/clusterAction';
...
const ViewRfpDocsModel = (props) => {
    ...
    const { getRfpList, getRfpLoading, getRfpActivityLoading, getRfpActivityData } = useSelector((state) => state.clusterAction);
