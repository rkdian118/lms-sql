        ...
        >
                ...
                <Transitions type={type} in={animate} position={position} direction="left">
                    <CardContent>
                        <Grid container spacing={gridSpacing} alignItems="center">
                            {!getPerformerLoading && bdPerformer?.topPerformers?.length > 0 ? (
                                bdPerformer?.topPerformers?.map((user, i) => (
            ...
            {!animate && (
                <Transitions type={type} in={!animate} position={position} direction={direction}>
                    <CardContent>
                        <Grid container spacing={gridSpacing} alignItems="center">
                            {!getPerformerLoading && clPerformer?.topPerformers?.length > 0 ? (
                                clPerformer?.topPerformers?.map((user, i) => (
                                    <Grid item xs={12} key={i}>
                                        <Grid container spacing={2}>
                                            <Grid item>
                                                <Box sx={{ position: 'relative' }}>
