...
import { DateRangeFilterSetup, LeadStatusRedirection, SelectedUserDataFilter } from 'store/slices/commonAction';
...
const LeadStatusCard = ({
    ...
    const onRedirectionLead = () => {
        ...
        dispatch(SelectedUserDataFilter({ bdId: bdeData, clId: clusterLeadData }));
        navigate('/leads');
    };
