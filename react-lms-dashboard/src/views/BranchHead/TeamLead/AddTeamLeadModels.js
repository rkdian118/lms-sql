...
import { AddTeamLeadApi } from 'store/slices/clusterAction';
...
const AddTeamLeadModels = (props) => {
    ...
    const { open, close, AddTeamLeadApi } = props;
...
export default connect(null, { AddTeamLeadApi })(AddTeamLeadModels);
