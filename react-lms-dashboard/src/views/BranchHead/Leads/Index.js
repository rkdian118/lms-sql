...
// import { ClearLeadActivityData, ClearFollowUpCallData } from 'store/slices/clusterAction';
import {
    GetAllLeadListApi,
...
import UploadLeadModel from './UploadLeadModel';
...
const Index = () => {
    ...
    const [openUploadLeadModel, setOpenUploadLeadModel] = useState(false);
    ...
    return (
                    ...
                    {DEV_TOOLS && (
                        <AnimateButton scale={{ hover: 1.1, tap: 0.9 }}>
                            <Button
                                variant="contained"
                                color="secondary"
                                onClick={() => setOpenUploadLeadModel(true)}
                                sx={{
                                    px: 3,
                                    mb: 1,
                                    width: '100%',
                            ...
                            >
                                <UploadIcon sx={{ mr: 1 }} /> Upload Lead
                            </Button>
                        </AnimateButton>
                    )}
                </Stack>
        ...
        >
            ...
            {openUploadLeadModel && <UploadLeadModel open={openUploadLeadModel} close={() => handleCloseModel()} />}
        </MainCard>
    );
};
