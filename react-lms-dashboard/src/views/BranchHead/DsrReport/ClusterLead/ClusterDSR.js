...
import { ClearDsrDetails, ClusterLeadDropDownApi, GetAllClusterDSRApi, GetDSRDetaiilApi } from 'store/slices/clusterAction';
...
const ClusterDSR = () => {
    ...
    const { getClusterDSRList, getClsuterDSRLoading, getClDropdownList } = useSelector((state) => state.clusterAction);
