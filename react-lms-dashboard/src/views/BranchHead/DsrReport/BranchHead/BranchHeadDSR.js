...
import { ClearDsrDetails, GetAllBranchHeadDSRApi, GetDSRDetaiilApi } from 'store/slices/clusterAction';
...
const BranchHeadDSR = () => {
    ...
    const { getBranchHeadDSRList, getBranchHeadDSRLoading, getBdeDropdownList } = useSelector((state) => state.clusterAction);
