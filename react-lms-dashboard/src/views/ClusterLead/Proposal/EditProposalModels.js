...
import { FILE_SUPPORTED_FORMATS, handleKeyBlock } from 'Helper/Validation';
...
import { ClusterUpdateProposalApi } from 'store/slices/clusterLeadAction';
...
const EditProposalModels = (props) => {
    ...
    const { getLeadDropdown } = useSelector((state) => state.clusterLeadAction);
