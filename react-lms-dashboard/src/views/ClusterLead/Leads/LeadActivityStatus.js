...
import { AddClusterCommentLeadActivityApi, ClusterGetLeadActivityDetailsApi } from 'store/slices/clusterLeadAction';
// tabs-
...
const LeadActivityStatus = (props) => {
    ...
    const { open, close, AddClusterCommentLeadActivityApi, rowData, leadId } = props;
    ...
    const handleUpdateActivityStatus = () => {
        ...
        dispatch(ClusterGetLeadActivityDetailsApi(leadId));
    };
    const initialValues = {
        new_Comment: ''
    };
    ...
    const onSubmit = (values, { setSubmitting, resetForm }) => {
        ...
        AddClusterCommentLeadActivityApi(newData)
            .then((res) => {
...
export default connect(null, { AddClusterCommentLeadActivityApi, ClusterGetLeadActivityDetailsApi })(LeadActivityStatus);
