...
const LeadSummary = ({ isLoading }) => {
    ...
    const primaryLight = navType === 'dark' ? alpha(theme.palette.primary.dark, 0.3) : theme.palette.primary.light;
    const secondaryMain = theme.palette.secondary.main;
    const secondaryLight = navType === 'dark' ? alpha(theme.palette.secondary.dark, 0.3) : theme.palette.secondary.light;
    const errorMain = theme.palette.error.main;
    const errorLight = navType === 'dark' ? alpha(theme.palette.error.dark, 0.3) : alpha(theme.palette.error.light, 0.6);
    const warningMain = theme.palette.warning.main;
    const warningLight = navType === 'dark' ? alpha(theme.palette.warning.dark, 0.2) : theme.palette.warning.light;
    ...
    switch (tabValue) {
        ...
        case 2:
            ...
            break;
        case 3:
            color = [primaryLight, errorMain];
            break;
        case 4:
            color = [errorLight, secondaryMain];
            break;
        default:
    ...
    const mixedChartOptions = {
        ...
        grid: {
            // borderColor: navType === 'dark' ? alpha(darkLight, 0.2) : grey200
        },
        tooltip: {
            theme: mode
        },
        ...
        <MainCard content={false}>
            <Box sx={{ p: 3 }}>
                <Grid container spacing={gridSpacing} rowSpacing={2.5}>
                    <Grid item xs={12}>
                        <Typography variant="h4">Branch Targets & Lead Summary</Typography>
                    </Grid>
                    <Grid item xs={12}>
                        <Tabs
                            value={tabValue}
                            ...
                            sx={{
                                '& a': {
                                    ...
                                    px: 1,
                                    mr: 2.2,
                                    color: theme.palette.navType === 'dark' ? 'grey.600' : 'grey.900',
                                    display: 'flex',
                                    flexDirection: 'row',
                                    alignItems: 'center',
