...
import { ProjectionStatusGetApi } from 'store/slices/masterAction';
import {
    Grid,
    Box,
    Chip,
...
const ProjectionStatusList = ({ ProjectionStatusGetApi }) => {
    const theme = useTheme();
    const { projectionStatusList, projectionStatusLoading } = useSelector((state) => state.masterAction);
            ...
            >
                <TableContainer>
                    <Table aria-label="simple table">
                        ...
                        <TableBody>
                            {!projectionStatusLoading && projectionStatusList.length > 0 ? (
...
export default connect(null, { ProjectionStatusGetApi })(ProjectionStatusList);
