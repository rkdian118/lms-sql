...
const EditMasterStatus = (props) => {
    const theme = useTheme();
    const { open, close, id, getName, statusType, name, color, UpdateMasterStatusApi } = props;
...
export default connect(null, { UpdateMasterStatusApi })(EditMasterStatus);
