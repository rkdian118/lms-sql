...
import { ClusterGetRfpActivityDetailsApi } from 'store/slices/adminAction';
...
const ViewRfpDocsModel = (props) => {
    ...
    const { getRfpList, getRfpLoading, getRfpActivityLoading, getRfpActivityData } = useSelector((state) => state.adminAction);
