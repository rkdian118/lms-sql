...
import { UpdateLeadActivityApi } from 'store/slices/adminAction';
...
const UpdateActivityModel = (props) => {
    ...
    const { open, close, UpdateLeadActivityApi, activityId, leadId } = props;
...
export default connect(null, { UpdateLeadActivityApi })(UpdateActivityModel);
