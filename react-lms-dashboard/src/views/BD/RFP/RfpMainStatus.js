...
import { UpdateRfpStatusApi } from 'store/slices/businessAction';
...
const RfpMainStatus = (props) => {
    ...
    const { open, close, UpdateRfpStatusApi, rfpId, rfpStatus } = props;
    const dispatch = useDispatch();
    const fileRef = useRef(null);
    const { rfpStatusList } = useSelector((state) => state.masterAction);
    const initialValues = {
        lead_status: '' || rfpStatus
    };
...
export default connect(null, { UpdateRfpStatusApi })(RfpMainStatus);
