...
import { UpdateBdTargetsApi } from 'store/slices/clusterLeadAction';
...
const UpdateBdTargets = (props) => {
    const theme = useTheme();
    const { open, close, UpdateBdTargetsApi, totalTarget, targetId } = props;
    ...
    const onSubmit = (values, { setSubmitting }) => {
        ...
        setLoader(true);
        UpdateBdTargetsApi(formData).then((res) => {
            // console.log('🚀  res:', res);
...
export default connect(null, { UpdateBdTargetsApi })(UpdateBdTargets);
