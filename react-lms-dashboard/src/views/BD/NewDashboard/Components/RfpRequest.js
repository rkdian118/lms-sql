        ...
        <>
            <TableRow hover key={key}>
                ...
                <TableCell align="left" sx={{ py: 1 }}>
                    {row?.resp?.length > 0 ? (
                        <Chip
                            label={row?.resp[0]?.status_name}
                            size="small"
                            variant="outlined"
                            sx={{
                                color: row?.resp[0]?.status_color,
                                borderColor: row?.resp[0]?.status_color,
                                fontSize: '0.875rem'
                            }}
                        />
                    ) : (
                ...
                <TableCell align="left" sx={{ py: 1 }}>
                    {moment(row?.resp[0]?.updatedAt).format('DD-MMM-YYYY')}
                </TableCell>
                                        ...
                                        <Table size="small" aria-label="purchases">
                                            <TableBody>
                                                ...
                                                <TableRow>
                                                    ...
                                                    <TableCell>{row?.rfpData[0]?.lead_rfp_status}</TableCell>
                                                    <TableCell>{row?.resp[0]?.status_name}</TableCell>
                                                    <TableCell>{moment(row?.resp[0]?.updatedAt).format('DD-MMM-YYYY')}</TableCell>
                                                </TableRow>
                                                <TableRow>
                                                ...
                                                <TableRow>
                                                    <TableCell>
                                                        {row?.rfpData[0]?.rfpResp?.pe_name ? row?.rfpData[0]?.rfpResp?.pe_name : '-'}
                                                    </TableCell>
                                                    <TableCell>
                                                        {row?.rfpData[0]?.rfpResp?.pe_email ? row?.rfpData[0]?.rfpResp?.pe_email : '-'}
                                                    </TableCell>
                                                    <TableCell>{row?.rfpData[0]?.proposal_value}</TableCell>
                                                    <TableCell sx={{ width: '320px' }}>
                                                        {row?.rfpData[0]?.rfpResp?.minutes_of_meeting &&
                                                        row?.rfpData[0]?.rfpResp?.minutes_of_meeting !== '' ? (
                                                    ...
                                                    <TableCell sx={{ width: '320px' }}>
                                                        {row?.rfpData[0]?.rfpResp?.remarks && row?.rfpData[0]?.rfpResp?.remarks !== '' ? (
                                                            <ReactReadMoreReadLess
                                                                charLimit={15}
                                                                readMoreText="Read more ▼"
                                                                readLessText="Read less ▲"
                                                            >
                                                                {row?.rfpData[0]?.rfpResp?.remarks}
                                                            </ReactReadMoreReadLess>
                                                        ) : (
                                                            '-'
                                                        )}
...
const RfpRequest = ({ startDate = '', endDate = '' }) => {
    ...
    const handleChangeRowsPerPage = async (event) => {
        await dispatch(GetAllRfpDataApi(startDate, endDate, currentPage + 1, event?.target.value));
