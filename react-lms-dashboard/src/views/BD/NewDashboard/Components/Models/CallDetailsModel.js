...
import { GetCallDetailsDataApi } from 'store/slices/businessAction';
...
const CallDetailsModel = (props) => {
    const { open, close, leadId, GetCallDetailsDataApi } = props;
...
export default connect(null, { GetCallDetailsDataApi })(CallDetailsModel);
