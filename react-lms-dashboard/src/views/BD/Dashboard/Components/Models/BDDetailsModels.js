...
import DsrReportModels from './DsrReportModels';
import RemoveBDModels from './RemoveBDModels';
...
const BDDetailsModels = (props) => {
    ...
    const onClickModel = (e, type) => {
        ...
        setOpenModel(true);
        if (type === 3) {
            dispatch(openPopupModel({ openItemKey: 'viewLeads', modalState: false }));
        }
    };
    ...
    return (
        <div>
            ...
            >
                ...
                >
                    <Typography variant="h6" component="h6" sx={{ pl: '10px', fontSize: '1em', color: '#d76a6a' }} align="center">
                        BD Details
                    </Typography>
                </BootstrapDialogTitle>
                <PerfectScrollbar
                ...
                {openModel && typeModel === 1 && <DsrReportModels open={openModel} close={() => setOpenModel(false)} />}
                {openModel && typeModel === 2 && <RemoveBDModels open={openModel} close={() => setOpenModel(false)} />}
...
export default connect(null, {})(BDDetailsModels);
