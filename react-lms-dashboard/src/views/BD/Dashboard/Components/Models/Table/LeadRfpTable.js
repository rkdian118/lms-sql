                    ...
                    {!getRfpDetailsLoading ? (
                        <>
                            ...
                            <TableRow hover>
                                ...
                                >
                                    {/* {getRfpDetailsData?.rfpData?.minutes_of_meeting} */}
                                    {getRfpDetailsData?.rfpData?.remarks && getRfpDetailsData?.rfpData?.remarks !== '' ? (
                                        <ReactReadMoreReadLess
                                            charLimit={50}
                                            sx={{ color: 'red' }}
                                            readMoreText="Read more ▼"
                                            readLessText="Read less ▲"
                                        >
                                            {getRfpDetailsData?.rfpData?.remarks}
                                        </ReactReadMoreReadLess>
                                    ) : (
                                        '-'
                                    )}
                            ...
                            <TableRow hover>
                                ...
                                <TableCell
                                    ...
                                    sx={{ width: '550px', py: '3px', color: '#000000', borderColor: '#0000005c', fontWeight: '500' }}
                                >
                                    {getRfpDetailsData?.rfpData?.pe_name !== '' ? getRfpDetailsData?.rfpData?.pe_name : '-'}
                                </TableCell>
                            </TableRow>
                            <TableRow hover>
                                <TableCell
                                ...
                                <TableCell
                                    ...
                                    sx={{ width: '550px', py: '3px', color: '#000000', borderColor: '#0000005c', fontWeight: '500' }}
                                >
                                    {getRfpDetailsData?.rfpData?.pe_email !== '' ? getRfpDetailsData?.rfpData?.pe_email : '-'}
                                </TableCell>
                            </TableRow>
                            <TableRow hover>
                                <TableCell
                        ...
                        <LeadDetailsTableLoader rows={20} />
                    )}
                </TableBody>
            </Table>
        </TableContainer>
