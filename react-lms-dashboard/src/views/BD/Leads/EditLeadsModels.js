    ...
    const getValidationSchema = () => {
        let schema = Yup.object({
            ...
            contact_number: Yup.string()
                .min(6, 'The WhatsApp Number Should Be b/w 6 to 16')
                .max(16, 'The WhatsApp Number Should Be b/w 6 to 16'), // Custom error message for required
                        ...
                        <Formik onSubmit={onSubmit}>
                            <form noValidate onSubmit={formik.handleSubmit}>
                                ...
                                <Grid container spacing={1} sx={{ p: '10px 30px', justifyContent: 'center' }}>
                                    ...
                                    <Grid item xs={8} sx={{ mb: 0, alignItems: 'left' }}>
                                        <Typography variant="h5" sx={{ width: '180px' }}>
                                            Add Notes
                                        </Typography>
                                        <TextField
