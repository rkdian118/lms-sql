...
import { Avatar, Box, Drawer, Grid, Stack, Typography, useMediaQuery } from '@mui/material';
...
import ProfilePicture from '../../../assets/images/ceo.png';
import ProfilePicture2 from '../../../assets/images/cto.png';
                                    ...
                                    >
                                        <Grid item xs={12} md={12} sx={{ display: 'flex', justifyContent: 'center' }}>
                                            <Link to="/dashboard">
                                                <Avatar
                                                    ...
                                                    sx={{ width: '120px', height: '120px', border: '3px solid #007DC3', cursor: 'pointer' }}
                                                />
                                            </Link>
                                        </Grid>
                                        <Grid item xs={12} md={12} sx={{ display: 'flex', justifyContent: 'center' }}>
                                            <Link to="/dashboard" style={{ textDecoration: 'none' }}>
                                                <Typography
                                                    variant="h4"
                                                    component="div"
                                                    sx={{ color: '#007DC3', fontSize: '20px', fontWeight: 600, cursor: 'pointer' }}
                                                >
                                                    {/* Swaraj Gupta */}
                                                    {adminDetails?.name}
                                                </Typography>
                                        ...
                                        <Grid item xs={12} md={12} sx={{ display: 'flex', justifyContent: 'center' }}>
                                            <Link to="/dashboard" style={{ textDecoration: 'none' }}>
                                                <Typography
                                                    variant="h4"
                                                    sx={{ color: '#007DC3', fontSize: '20px', fontWeight: 400, cursor: 'pointer' }}
                                                >
