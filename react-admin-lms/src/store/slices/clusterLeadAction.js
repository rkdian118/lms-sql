    ...
    async () => {
        try {
            const response = await axiosApiHelper(
                'get',
                `${PROXY}cl-dashboard-followup-leads?start_date=${startDate}&end_date=${endDate}&bd_id=${bdId}`
            );
            if (response.data.succeeded === true) {
...
export const ClusterGetAllCallsDataApi =
    ...
    async () => {
        try {
            const response = await axiosApiHelper(
                'get',
                `${PROXY}cl-dashboard-call-leads?start_date=${startDate}&end_date=${endDate}&bd_id=${bdId}`
            );
            if (response.data.succeeded === true) {
...
export const GetAllLeadListApi =
    ...
    async () => {
        try {
            const response = await axiosApiHelper(
                'get',
                `${PROXY}cl-get-leads?page=${page}&limit=${limit}&search=${search}&lead_status_id=${leadStatus}&bd_id=${bdId}`
            );
            if (response.data.succeeded === true) {
...
export const ClusterGetAllCallsApi =
    (page = '', limit = '', search = '', leadId = '', bdId = '') =>
    async () => {
        try {
            const response = await axiosApiHelper(
                'get',
                `${PROXY}cl-get-lead-call?page=${page}&limit=${limit}&search=${search}&lead_id=${leadId}&bd_id=${bdId}`
            );
            if (response.data.succeeded === true) {
...
export const ClusterGetAllRfpRequestApi =
    (page = '', limit = '', search = '', bdId = '') =>
    async () => {
        try {
            const response = await axiosApiHelper('get', `${PROXY}cl-get-rfp?page=${page}&limit=${limit}&search=${search}&bd_id=${bdId}`);
            if (response.data.succeeded === true) {
...
export const ClusterGetAllProposalApi =
    ...
    async () => {
        try {
            const response = await axiosApiHelper(
                'get',
                `${PROXY}cl-get-proposal?page=${page}&limit=${limit}&search=${search}&bd_id=${bdId}`
            );
            if (response.data.succeeded === true) {
...
export const GetFollowUpsDetailApi = (data) => async () => {
    try {
        const response = await axiosApiHelper('get', `${PROXY}cl-get-lead-followup-call?lead_id=${data}`);
        if (response.data.succeeded === true) {
