...
export const GetAllLeadApi =
    (page = '', limit = '', search = '', leadStatus = '') =>
    async () => {
        try {
            const response = await axiosApiHelper(
                'get',
                `${PROXY}get-leads?page=${page}&limit=${limit}&search=${search}&lead_status_id=${leadStatus}`
            );
...
export const GetAllCallsApi =
    (page = '', limit = '', search = '', leadId = '', callStatusId = '') =>
    async () => {
        try {
            const response = await axiosApiHelper(
                'get',
                `${PROXY}get-lead-call?page=${page}&limit=${limit}&search=${search}&lead_id=${leadId}&call_status_id=${callStatusId}`
            );
            if (response.data.succeeded === true) {
...
export const GetAllRfpRequestApi =
    (page = '', limit = '', search = '', rfpStatusId = '') =>
    async () => {
        try {
            const response = await axiosApiHelper(
                'get',
                `${PROXY}get-rfp?page=${page}&limit=${limit}&search=${search}&lead_rfp_status_id=${rfpStatusId}`
            );
            if (response.data.succeeded === true) {
...
export const GetAllProposalApi =
    ...
    async () => {
        try {
            const response = await axiosApiHelper('get', `${PROXY}get-proposal?page=${page}&limit=${limit}&search=${search}`);
            if (response.data.succeeded === true) {
...
export const GetAllFollowUpsDataApi =
    ...
    async () => {
        try {
            const response = await axiosApiHelper('get', `${PROXY}dashboard-followup-leads?start_date=${startDate}&end_date=${endDate}`);
            if (response.data.succeeded === true) {
...
export const GetAllCallsDataApi =
    ...
    async () => {
        try {
            const response = await axiosApiHelper('get', `${PROXY}dashboard-call-leads?start_date=${startDate}&end_date=${endDate}`);
            if (response.data.succeeded === true) {
...
export const GetAllRfpDataApi =
    ...
    async () => {
        try {
            const response = await axiosApiHelper('get', `${PROXY}dashboard-rfp-leads?start_date=${startDate}&end_date=${endDate}`);
            if (response.data.succeeded === true) {
...
export const GetFollowUpsDetailApi = (data) => async () => {
    try {
        const response = await axiosApiHelper('get', `${PROXY}get-lead-followup-call?lead_id=${data}`);
        if (response.data.succeeded === true) {
