...
import { GetFollowUpsDetailApi } from 'store/slices/clusterLeadAction';
...
const FollowUpCalls = (props) => {
    ...
    const { getFollowUpsCallsDetails, getFollowUpsCallsDetailsLoading } = useSelector((state) => state.clusterLeadAction);
    const blockSX = {
        p: 2.5,
        border: '1px solid ',
