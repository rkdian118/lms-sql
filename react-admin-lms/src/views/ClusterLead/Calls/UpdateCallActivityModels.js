...
import { ClusterUpdateCallActivityApi } from 'store/slices/clusterLeadAction';
...
const UpdateCallActivityModels = (props) => {
    ...
    const { open, close, ClusterUpdateCallActivityApi, activityId } = props;
    ...
    const validationSchema = Yup.object({
        call_activity_id: Yup.string().required('Follow-Ups Field is Required'),
    ...
    const onSubmit = (values, { setSubmitting }) => {
        ...
        ClusterUpdateCallActivityApi(newData)
            .then((res) => {
...
export default connect(null, { ClusterUpdateCallActivityApi })(UpdateCallActivityModels);
