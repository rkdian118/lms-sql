...
import { CluserUpdateCallsApi } from 'store/slices/clusterLeadAction';
...
const EditCallsModels = (props) => {
    const { open, close, CluserUpdateCallsApi, rowData } = props;
...
export default connect(null, { CluserUpdateCallsApi })(EditCallsModels);
