...
const TabComponent = ({ startDate, endDate, bdeData }) => {
    ...
    // console.log('Total Array Length:', followUpCount.totalArrayLength);
    return (
        <>
            <Tabs
                value={value}
            ...
            >
                ...
                >
                    <TabPanel value={value} index={0} sx={{ padding: '0px' }}>
                        <FollowUpsList startDate={startDate} endDate={endDate} bdeData={bdeData} />
                    </TabPanel>
                    <TabPanel value={value} index={1}>
                        <ScheduledCalls startDate={startDate} endDate={endDate} bdeData={bdeData} />
                    </TabPanel>
                    <TabPanel value={value} index={2}>
                        <RfpRequest startDate={startDate} endDate={endDate} bdeData={bdeData} />
                    </TabPanel>
                </PerfectScrollbar>
            </MainCard>
