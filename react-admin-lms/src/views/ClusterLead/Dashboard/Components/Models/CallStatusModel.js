...
const CallStatusModel = (props) => {
    const theme = useTheme();
    const { open, close, ClusterUpdateCallActivityApi, activityId, callStatusId } = props;
...
export default connect(null, { ClusterUpdateCallActivityApi })(CallStatusModel);
