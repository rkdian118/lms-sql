...
const Dashboard = (props) => {
    ...
    useEffect(() => {
        ...
        ClusterGetAllFollowUpsDataApi(startDate, endDate, bdeData);
        ClusterGetAllCallsDataApi(startDate, endDate, bdeData);
        ClusterGetAllRfpDataApi(startDate, endDate, bdeData);
        setLoading(false);
    ...
    const defaultExpandData = [
        ...
        },
        {
            ...
            content: <ReportSection leadStatusCount={LeadStatusDataConvert(getDashboardData)} />
        }
    ];
    return (
        <>
            <Grid container spacing={gridSpacing}>
                <Grid item xs={12}>
                    <Grid container spacing={gridSpacing}>
                        {/* <Grid item xs={12} md={6}>
                            <Grid item>
                                <Typography
                                    ...
                                    // color="secondary"
                                    mb={2}
                                    sx={{ fontSize: '1.5rem', textAlign: 'center', paddingTop: '0px' }}
                                >
                                    Today Task
                                </Typography>
                            </Grid>
                            <TabComponent startDate={startDate} endDate={endDate} bdeData={bdeData} />
                        </Grid> */}
                        <Grid item xs={12} md={collapse ? 12 : 6}>
                            <MainCard
                                content={false}
                        ...
                        <Grid item xs={12} md={collapse ? 12 : 6} sx={{ padding: '24px 0 16px 24px' }}>
