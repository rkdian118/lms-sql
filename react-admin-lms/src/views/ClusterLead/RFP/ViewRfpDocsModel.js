...
import { ClusterGetRfpActivityDetailsApi } from 'store/slices/clusterLeadAction';
...
const ViewRfpDocsModel = (props) => {
    ...
    const { getRfpList, getRfpLoading, getRfpActivityLoading, getRfpActivityData } = useSelector((state) => state.clusterLeadAction);
    ...
    const onTabClick = (row) => {
        ...
        dispatch(ClusterGetRfpActivityDetailsApi(row?._id));
    };
    ...
    const handleUpdateActivityStatus = () => {
        ...
        dispatch(ClusterGetRfpActivityDetailsApi(id));
    };
                                                                ...
                                                                label={
                                                                    <Grid container direction="column">
                                                                        ...
                                                                        >
                                                                            ...
                                                                            <Typography component="div" variant="caption">
                                                                                {moment(tab?.createdAt).format('Do MMM hh:mm a')}
                                                                            </Typography>
                                                                        </Typography>
                                                                    </Grid>
                                                                }
                                                            ...
                                                            {!getRfpActivityLoading && getRfpActivityData.length > 0 ? (
                                                                getRfpActivityData.map((row, i) => (
                                                                    <TableRow hover key={i}>
                                                                        ...
                                                                        <TableCell>
                                                                            {moment(row?.updatedAt).format('Do MMM hh:mm a')}
                                                                        </TableCell>
                                                                        <TableCell>
                                                                            {moment(row?.createdAt).format('Do MMM hh:mm a')}
                                                                        </TableCell>
                                                                        <TableCell align="right" sx={{ pr: 3 }}>
                                                                    ...
                                                                    <Grid container spacing={1}>
                                                                        ...
                                                                        >
                                                                            ...
                                                                            <Typography
                                                                                ...
                                                                                color={theme.palette.mode === 'dark' ? 'dark.900' : ''}
                                                                            >
                                                                                {moment(use?.createdAt).format('Do MMM YYYY hh:mm a')}
                                                                            </Typography>
                                                                        </Grid>
                                                                    </Grid>
                                                                </CardContent>
                                                        ...
                                                        <Grid container spacing={1}>
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    ...
                                                                    {moment(commentData?.createdAt).format('Do MMM YYYY hh:mm a')}
                                                                </Typography>
                                                            </Grid>
                                                        </Grid>
                                                    </CardContent>
