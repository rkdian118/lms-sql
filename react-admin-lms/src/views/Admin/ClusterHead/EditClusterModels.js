...
import { ActiveBranchApi, UpdateClusterApi, ClusterGetDetailsApi } from 'store/slices/adminAction';
...
const EditClusterModels = (props) => {
    const { open, close, clusterId, ClusterGetDetailsApi, ActiveBranchApi, UpdateClusterApi } = props;
...
export default connect(null, { ActiveBranchApi, UpdateClusterApi, ClusterGetDetailsApi })(EditClusterModels);
