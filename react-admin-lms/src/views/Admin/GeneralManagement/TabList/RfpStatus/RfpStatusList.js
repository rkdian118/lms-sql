...
import AddCallMode from './AddRfpStatus';
import EditCallMode from './EditRfpStatus';

const RfpStatusList = ({ RfpStatusGetApi }) => {
    const { rfpStatusList, rfpStatusLoading } = useSelector((state) => state.masterAction);
    ...
    return (
        <>
            ...
            {!rfpStatusLoading && rfpStatusList.length > 0 ? (
...
export default connect(null, { RfpStatusGetApi })(RfpStatusList);
