...
const EditProposalStatus = (props) => {
    const theme = useTheme();
    const { open, close, id, getName, UpdateMasterStatusApi } = props;
...
export default connect(null, { UpdateMasterStatusApi })(EditProposalStatus);
