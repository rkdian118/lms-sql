...
const AddPreDefine = (props) => {
    ...
    const validationSchema = Yup.object({
        common_name: Yup.string().required('Note Field is Required').min(3, 'Note must be at least 3 characters')
...
export default connect(null, { AddMasterStatusApi })(AddPreDefine);
