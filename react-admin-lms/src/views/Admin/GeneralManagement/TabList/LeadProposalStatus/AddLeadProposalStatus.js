...
const AddLeadProposalStatus = (props) => {
    ...
    const onSubmit = (values, { setSubmitting }) => {
        const newData = {
            ...
            status_type: 'lead_proposal_status'
        };
...
export default connect(null, { AddMasterStatusApi })(AddLeadProposalStatus);
