...
import AddCallType from './AddCallStatus';
import EditCallType from './EditStatusType';

const CallStatusList = ({ CallStatusGetApi }) => {
    const { callStatusList, callStatusLoading } = useSelector((state) => state.masterAction);
    ...
    return (
        <>
            ...
            {!callStatusLoading && callStatusList.length > 0 ? (
...
export default connect(null, { CallStatusGetApi })(CallStatusList);
