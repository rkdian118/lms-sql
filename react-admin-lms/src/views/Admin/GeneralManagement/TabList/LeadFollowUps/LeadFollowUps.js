...
import AddCallMode from './AddLeadFollowUps';
import EditCallMode from './EditLeadFollowUps';

const LeadFollowUps = ({ LeadFollowUpsGetApi }) => {
    const { leadFollowUpList, leadFollowUpLoading } = useSelector((state) => state.masterAction);
    ...
    return (
        <>
            ...
            {!leadFollowUpLoading && leadFollowUpList.length > 0 ? (
...
export default connect(null, { LeadFollowUpsGetApi })(LeadFollowUps);
