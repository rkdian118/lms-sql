...
import { CallTypeGetApi } from 'store/slices/masterAction';
...
const CallTypeList = ({ CallTypeGetApi }) => {
    const { callTypeList, callTypeLoading } = useSelector((state) => state.masterAction);
    ...
    return (
        <>
            ...
            {!callTypeLoading && callTypeList.length > 0 ? (
...
export default connect(null, { CallTypeGetApi })(CallTypeList);
