...
import { AddLeadApi } from 'store/slices/businessAction';
...
const AddLeadsModels = (props) => {
    const theme = useTheme();
    const { open, close, AddLeadApi } = props;
    ...
    const getValidationSchema = () => {
        let schema = Yup.object({
            ...
            client_name: Yup.string()
                ...
                .min(3, 'Client name should contain characters b/w 3 to 25')
                .max(25, 'Client name should contain characters b/w 3 to 25'),
            country: Yup.mixed().required('Country Field is Required'), // Custom error message for required
            contact_number: Yup.string()
                .min(10, 'The Contact Number Should Be b/w 5 to 15')
                .max(15, 'The Contact Number Should Be b/w 5 to 15'), // Custom error message for required
            whatsapp_number: Yup.string()
                .min(10, 'The WhatsApp Number Should Be b/w 5 to 15')
                .max(15, 'The WhatsApp Number Should Be b/w 5 to 15') // Custom error message for required
        ...
        AddLeadApi(newData)
            .then((res) => {
                ...
                if (res?.succeeded === true) {
                    ...
                    // console.log('agya iss me', res.ResponseMessage);
                    setDuplicateData(res?.ResponseData);
    ...
    // console.log('🚀duplicateOpen', duplicateData);
    ...
    return (
        <div>
                        ...
                        <Formik onSubmit={onSubmit}>
                            <form noValidate onSubmit={formik.handleSubmit}>
                                ...
                                <Grid container spacing={1} sx={{ p: '10px 30px', justifyContent: 'center' }}>
                                    ...
                                    <Grid item xs={4} sx={{ mb: 0, alignItems: 'left' }}>
                                        <Typography variant="h5" sx={{ width: '180px' }}>
                                            Email{typeData === 1 ? <span style={{ color: 'red' }}>*</span> : ''}
                                        </Typography>
                                        <TextField
                                            fullWidth
                                    ...
                                    <Grid item xs={4} sx={{ mb: 0, alignItems: 'left' }}>
                                        <Typography variant="h5" sx={{ width: '180px' }}>
                                            LinkedIn URL{typeData === 2 ? <span style={{ color: 'red' }}>*</span> : ''}
                                        </Typography>
                                        <TextField
                                            fullWidth
                                    ...
                                    <Grid item xs={4} sx={{ mb: 0, alignItems: 'left' }}>
                                        <Typography variant="h5" sx={{ width: '180px' }}>
                                            Upwork URL{typeData === 3 ? <span style={{ color: 'red' }}>*</span> : ''}
                                        </Typography>
                                        <TextField
                                            fullWidth
                                    ...
                                    <Grid item xs={4} sx={{ mb: 0, alignItems: 'left' }}>
                                        <Typography variant="h5" sx={{ width: '180px' }}>
                                            Bid URL{typeData === 3 ? <span style={{ color: 'red' }}>*</span> : ''}
                                        </Typography>
                                        <TextField
                                            fullWidth
                                    ...
                                    <Grid item xs={4} sx={{ mb: 0, alignItems: 'left' }}>
                                        <Typography variant="h5" sx={{ width: '180px' }}>
                                            Proposal Amount{typeData === 3 ? <span style={{ color: 'red' }}>*</span> : ''}
                                        </Typography>
                                        <TextField
                                            fullWidth
                                    ...
                                    <Grid item xs={4} sx={{ mb: 0, alignItems: 'left' }}>
                                        <Typography variant="h5" sx={{ width: '180px' }}>
                                            Client Budget{typeData === 3 ? <span style={{ color: 'red' }}>*</span> : ''}
                                        </Typography>
                                        <TextField
                                            fullWidth
                                            ...
                                            onChange={formik.handleChange}
                                            error={formik.touched.client_budget && Boolean(formik.errors.client_budget)}
            ...
            {duplicateOpen && (
                <DuplicateLeadModel duplicateData={duplicateData} open={duplicateOpen} close={() => setDuplicateOpen(false)} />
            )}
        </div>
    );
};

export default connect(null, { AddLeadApi })(AddLeadsModels);
