...
import { UpdateLeadApi } from 'store/slices/businessAction';
...
const EditLeadsModels = (props) => {
    ...
    const { open, close, UpdateLeadApi, rowData } = props;
...
export default connect(null, { UpdateLeadApi })(EditLeadsModels);
