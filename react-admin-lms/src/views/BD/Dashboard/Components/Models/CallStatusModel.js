...
import { UpdateCallActivityApi } from 'store/slices/businessAction';
...
const CallStatusModel = (props) => {
    ...
    const { open, close, UpdateCallActivityApi, activityId, callStatusId } = props;
...
export default connect(null, { UpdateCallActivityApi })(CallStatusModel);
