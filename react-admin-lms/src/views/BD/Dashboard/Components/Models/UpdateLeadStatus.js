...
import { UpdateLeadStatusApi } from 'store/slices/businessAction';
...
const UpdateLeadStatus = (props) => {
    ...
    const { open, close, UpdateLeadStatusApi, leadId, leadStatusId } = props;
...
export default connect(null, { UpdateLeadStatusApi })(UpdateLeadStatus);
