...
import { UpdateRfpRequestApi } from 'store/slices/businessAction';
...
const EditRfpModels = ({ open, close, UpdateRfpRequestApi, rowData }) => {
                            ...
                            <form noValidate onSubmit={formik.handleSubmit}>
                                ...
                                <Grid container spacing={2} sx={{ p: '10px 30px' }}>
                                    ...
                                    <Grid item xs={12} sx={{ mb: 0, alignItems: 'left' }}>
                                        <TextField
                                            fullWidth
                                            placeholder="Enter Propsal Value"
                                            name="proposal_value"
...
export default connect(null, { UpdateRfpRequestApi })(EditRfpModels);
