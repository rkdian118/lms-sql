...
import { UpdateRfpActivityApi } from 'store/slices/businessAction';
...
const UpdateRfpActivityModels = (props) => {
    ...
    const { open, close, UpdateRfpActivityApi, activityId } = props;
...
export default connect(null, { UpdateRfpActivityApi })(UpdateRfpActivityModels);
