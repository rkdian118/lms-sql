        ...
        <>
            ...
            >
                <Grid container spacing={2} sx={{ '&.MuiGrid-root': { pt: 0 } }}>
                    <Grid item xs={3} md={3} sx={{ mb: 2, alignItems: 'left' }}>
                        <form onSubmit={formik.handleSubmit}>
                            <Grid container spacing={gridSpacing} sx={{ mt: 1, px: 2 }}>
                                ...
                                <Grid item xs={12} sx={{ mb: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                    {/* <Box
                                        style={{
                                            display: 'flex',
                    ...
                    <Grid item xs={9} md={9} sx={{ mb: 2, alignItems: 'left' }}>
                        {/* {usersResult} */}
