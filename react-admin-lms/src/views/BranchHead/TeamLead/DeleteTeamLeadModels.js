...
const DeleteTeamLeadModels = ({ open, close, deleteData, TeamLeadStatusChangeApi }) => {
    ...
    const onDeleteStatus = () => {
        setIsLoading(true);
        const newData = { manager_id: deleteData._id, status: '3' };
        TeamLeadStatusChangeApi(newData)
            .then((res) => {
                setIsLoading(false);
                close();
                if (res.succeeded === true) {
                    dispatch(TeamLeadGetApi(1, 100));
                    dispatch(
                        openSnackbar({
                            open: true,
                        ...
                        <DialogContent>
                            ...
                            >
                                ...
                                <Button
                                    ...
                                    disabled={isLoading}
                                >
                                    {isLoading ? ( // Show loader when form is submitting
                                        <>
...
export default connect(null, { TeamLeadStatusChangeApi })(DeleteTeamLeadModels);
