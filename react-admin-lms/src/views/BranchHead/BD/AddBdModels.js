...
import { AddBDApi, ClusterLeadDropDownApi } from 'store/slices/clusterAction';
...
const AddBdModels = (props) => {
    const theme = useTheme();
    const { open, close, AddBDApi, ClusterLeadDropDownApi } = props;
    ...
    // const [teamLeadData, setTeamLeadData] = useState([
    //     { clusterLead_id: 1, teamLead_name: 'John' },
    //     { clusterLead_id: 2, teamLead_name: 'James' }
    // ]);
    ...
    const validationSchema = Yup.object({
        ...
        clusterLead_id: Yup.string().required('Cluster Lead Field is Required'),
        emp_id: Yup.string()
    ...
    // console.log('values.emp_id', values.emp_id);
    ...
    return (
        <div>
            ...
            >
                <BootstrapDialogTitle id="customized-dialog-title" onClose={handleClose} sx={{ background: '#cffea0' }}>
                    <Typography variant="h6" component="h6" sx={{ pl: '10px', fontSize: '1em', color: '#4a873b' }} align="center">
                        Add BDE
                    </Typography>
                        ...
                        <Formik>
                            <form noValidate onSubmit={formik.handleSubmit}>
                                <Grid container spacing={2} sx={{ p: '10px 30px' }}>
                                    ...
                                    <Grid item xs={6} sx={{ mb: 0, alignItems: 'left' }}>
                                        <Typography variant="h5" sx={{ width: '180px' }}>
                                            Cluster Lead Name<span style={{ color: 'red' }}>*</span>
                                        </Typography>
                                        ...
                                        <FormControl fullWidth>
                                            ...
                                            >
                                                <MenuItem value="">Select Cluster Lead</MenuItem>
                                ...
                                >
                                    <Button
                                        ...
                                        sx={{
                                            ...
                                            background: '#cffea0',
                                            height: '35px',
                                            '&:hover': { background: '#4a873b', color: '#cffea0' }
                                        }}
                                    >
...
export default connect(null, { AddBDApi, ClusterLeadDropDownApi })(AddBdModels);
