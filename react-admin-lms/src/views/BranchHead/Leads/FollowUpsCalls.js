...
import { GetFollowUpsDetailApi } from 'store/slices/clusterAction';
...
const FollowUpCalls = (props) => {
    ...
    const { getFollowUpsCallsDetails, getFollowUpsCallsDetailsLoading } = useSelector((state) => state.clusterAction);
    const blockSX = {
        p: 2.5,
        border: '1px solid ',
                        ...
                        <Grid container spacing={1}>
                            ...
                            <Grid item xs={12} sx={{ '&.MuiGrid-root': { pt: '0px' } }}>
                                ...
                                >
                                    ...
                                    {/* <PersonOutlineTwoToneIcon sx={{ width: '15px' }} /> {use?.comment_by} */}
                                </CardContent>
                            </Grid>
                        </Grid>
                    </DialogContent>
