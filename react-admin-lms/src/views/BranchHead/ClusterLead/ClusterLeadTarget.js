...
const ClusterLeadTarget = ({ AllTargetGetApi }) => {
        ...
        <MainCard content={false} sx={{ border: '0px solid', padding: '10px' }}>
            <Grid container spacing={1}>
                <Grid item xs={12} md={10}>
                    ...
                    >
                        Cluster Lead Target Based On Month
                    </Typography>
                </Grid>
                                ...
                                >
                                    <Grid item xs={3} sx={{ display: 'flex', alignItems: 'center' }} px="10px">
                                        ...
                                        <Grid container spacing={2} alignItems="center">
                                            ...
                                            <Grid item>
                                                <Avatar alt={list.name} src={`${BASE_URL}${list?.clusterLead?.profile_pic}`} />
                                            </Grid>
                                            <Grid item xs zeroMinWidth>
                                                <Typography align="left" component="div" variant="subtitle1" sx={{ color: '#000000' }}>
                                                    {list?.clusterLead?.name}
                                                ...
                                                <Typography align="left" component="div" variant="subtitle2" sx={{ color: '#000000' }}>
                                                    {list?.clusterLead?.emp_id} ({list?.clusterLead?.designation})
                                                </Typography>
                                            </Grid>
                                        </Grid>
                                        {/* <Grid container spacing={2} alignItems="center">
                                            ...
                                            <Grid item>
                                                <Avatar alt="Preview" src={`${BaseURL}${list?.clusterLead?.profile_pic}`} />
                                            </Grid>
                                            <Grid item xs zeroMinWidth>
                                                <Typography align="left" component="div" variant="subtitle1" sx={{ color: '#000000' }}>
                                                    {list?.clusterLead?.name}
...
export default connect(null, { AllTargetGetApi })(ClusterLeadTarget);
