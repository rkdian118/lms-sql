...
import { AddClusterLeadApi, TeamLeadDropDownApi } from 'store/slices/clusterAction';
...
const AddClusterLeadModels = (props) => {
    const theme = useTheme();
    const { open, close, AddClusterLeadApi, TeamLeadDropDownApi } = props;
    ...
    const validationSchema = Yup.object({
        ...
        // teamLead_id: Yup.string().required('Team Lead Field is Required'),
        username: Yup.string()
    ...
    const onSubmit = (values, { setSubmitting }) => {
        ...
        // formData.append('manager_id', values.teamLead_id);
                        ...
                        <Formik>
                            <form noValidate onSubmit={formik.handleSubmit}>
                                <Grid container spacing={2} sx={{ p: '10px 30px' }}>
                                    ...
                                    {/* <Grid item xs={6} sx={{ mb: 0, alignItems: 'left' }}>
                                        <Typography variant="h5" sx={{ width: '180px' }}>
                                            Tean Lead Name<span style={{ color: 'red' }}>*</span>
                                        </Typography>
...
export default connect(null, { AddClusterLeadApi, TeamLeadDropDownApi })(AddClusterLeadModels);
